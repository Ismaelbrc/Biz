...
def add_body(text):
    """Parágrafo de corpo com primeira linha recuada."""
    # Divide em linhas para processar itálicos inline
    p = doc.add_paragraph()
...
def add_dialogue(text):
    """Parágrafo de diálogo com recuo."""
    p = doc.add_paragraph()
    p.paragraph_format.first_line_indent = Cm(1.25)
    p.paragraph_format.space_after = Pt(0)
    p.paragraph_format.line_spacing = Pt(20)
...
add_subtitle('Carol Sturka')

# --- PARTE UM ---
add_part_title('PARTE UM\nO Vento Ladrão')

# ================================================================
# CAPÍTULO 1
# ================================================================
add_chapter_title('Capítulo 1 — O Manifesto')
...
paragrafos_cap1b = [
    ...
    'Ela esperou o protesto. A contra-proposta.',
...
for p in paragrafos_cap1:
    add_body(p)
add_separator()
for p in paragrafos_cap1b:
    add_body(p)
add_separator()
for p in paragrafos_cap1c:
    add_body(p)

# ================================================================
# CAPÍTULO 2
# ================================================================
add_chapter_title('Capítulo 2 — Porão de Carga')
...
cap2 = [
    ...
    'Ele tinha o hábito, desenvolvido em dezoito meses de movimento constante, de avaliar cada navio que pisava pelo que ele poderia fazer em emergência. Era prático. Era também a única forma de ocupar a cabeça que havia encontrado que não deixava espaço para outras coisas.',
...
# CAPÍTULO 3
# ================================================================
add_chapter_title('Capítulo 3 — Wyld Bourbon e Pior Decisão')
...
cap3a = [
    ...
    'A pausa antes de aceitar não era hesitação. Era cálculo: o que isso significava, o que não significava, se havia alguma razão tática para recusar. Não havia. Ela bebeu, devolveu.',
    ...
    '— *Conhecia* os distribuidores. As rotas mudam.',
    ...
    'Ela se endireitou do corrimão. O vento havia mudado mais dois graus — ela precisava verificar os instrumentos.',
...
# CAPÍTULO 4
# ================================================================
add_chapter_title('Capítulo 4 — O Que o Mercator Guarda')
...
cap4c = [
    'O porão de provisões cheirava a mandovian spicefruit e a cera de proteção de madeira. Ela verificou a fixação dos caixotes — todos corretos, amarrações sem folga, nenhum deslocamento na última hora. Às quatro da manhã o porão estava frio e silencioso.',
    'Ela subiu.',
...
cap4e = [
    ...
    'Ela não as lia. Não as havia enviado. Continuava escrevendo-as porque havia aprendido que havia coisas que precisavam sair do sistema de alguma forma — e que se não podiam sair pela boca precisavam ir a algum lugar.',
...
# --- Salvar ---
output_path = '/home/user/Biz/winds-of-wycaro-caps1-4.docx'
